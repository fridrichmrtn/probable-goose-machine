...
Anchor quote rules (anti-paraphrase — these are LITERAL):
  ...
  - `anchor.section` should copy the visible CV header the quote sits under, without translating it (e.g. "Work Experience", "Education", "Skills", "Vzdělání", "Akademická praxe"). If you are unsure which header, set section to null — the verifier will fall back to whole-CV match.
